...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        if (numOfKings == 1) {
            setTimeout(() => {
                // Determine winner based on the turn and create the winner image
                let winnerImage = document.createElement("img");
                winnerImage.classList.add("win-image");
        
                // Create a text overlay for "White Won" or "Black Won"
                let winnerText = document.createElement("div");
                winnerText.classList.add("winner-text");
        
                if (tog % 2 == 0) {
                    winnerImage.src = "white.jpg"; // Image for White winning
                    winnerText.textContent = "White Won!";
                } else {
                    winnerImage.src = "black.jpg"; // Image for Black winning
                    winnerText.textContent = "Black Won!";
                }
        
                // Append the winner image and text to the body
                document.body.appendChild(winnerImage);
                document.body.appendChild(winnerText);
        
                // Add confetti effect class to body for background animation
                document.body.classList.add("confetti-effect");
        
                // Set reload after a brief delay (e.g., 3 seconds) to reset the game
